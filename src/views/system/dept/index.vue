		...
		<el-card shadow="always">
			...
			<el-table v-loading="state.loading" :data="state.tableData" row-key="deptId" border default-expand-all
				...
				<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
					<template #default="scope">
						<el-button type="text" v-auth="'system:dept:edit'" @click="onOpenEditModule(scope.row)">
							<SvgIcon name="ele-Edit" />修改
						</el-button>
						<el-button type="text" v-auth="'system:dept:add'" @click="onOpenAddModule(scope.row)">
							<SvgIcon name="ele-Plus" />新增
						</el-button>
						<el-button v-if="scope.row.parentId != 0" type="text" v-auth="'system:dept:delete'"

<template>
	<div class="layout-navbars-breadcrumb-user" :style="{ flex: layoutUserFlexNum }">
		...
		<!-- <div class="layout-navbars-breadcrumb-user-icon" @click="backPlatform">
			<i class="icon-shibai iconfont" title="返回平台"></i>
		</div> -->
		<el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
			...
			<template #dropdown>
				<el-dropdown-menu>
					...
					<el-dropdown-item divided command="logOut">返回系统</el-dropdown-item>
				</el-dropdown-menu>
			</template>
		</el-dropdown>
	...
	setup() {
		...
		const onHandleCommandClick = (path: string) => {
			if (path === 'logOut') {
				...
				window.open('https://gitee.com/diygw/diygw-ui-admin');
			} else {
				router.push(path);
			}
		};
		...
		const backPlatform = ()=>{
			location.href=window['diygwcom']['homeurl']
		}
		return {
			getUserInfos,
